/-
Kairos.Stats.Tactic.CSFamilyAttrTest — regression for the
...
@[cs_family]
noncomputable def testFamily : Kairos.Stats.CSFamily where
  eta := fun _ => 1.0
  slackFn := fun _ _ => 1.0
...
-- registered family including `Kairos.Stats.Tactic.Test.testFamily`.
#cs_families
