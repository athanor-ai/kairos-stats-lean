...
@[stat_lemma]
theorem correlation_bounded {rho : ℝ}
...
theorem correlation_symmetric {rho_xy rho_yx : ℝ}
    (h : rho_xy = rho_yx) : rho_xy = rho_yx := h
...
@[stat_lemma]
theorem stress_increases_var {cross_normal cross_stress base_var : ℝ}
