...
**Coverage**:
- 1366 theorem/lemma declarations in `Pythia/`
- 217 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 888
