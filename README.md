...
mathematics and computer science. It provides 740 sorry-free theorems
...
**Coverage**:
- 1193 theorem/lemma declarations in `Pythia/`
...
The repository includes a full-text search index over all 740
