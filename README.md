...
mathematics and computer science. It provides 1023 sorry-free theorems
...
**Coverage**:
- 1538 theorem/lemma declarations in `Pythia/`
...
| `Pythia.Hardware` | 148 | k-induction soundness, bit-vector modular arithmetic, Gray code single-bit adjacency, FIFO pointer conditions, Hamming distance metric and detection/correction capacity, Singleton bound, CDC synchronizer MTBF exponential growth |
...
The repository includes a full-text search index over all 1023
