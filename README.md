...
**Coverage**:
- 1382 theorem/lemma declarations in `Pythia/`
- 233 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 904
