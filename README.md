...
**Coverage**:
- 1379 theorem/lemma declarations in `Pythia/`
- 230 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 901
