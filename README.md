...
**Coverage**:
- 1378 theorem/lemma declarations in `Pythia/`
- 229 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 900
