...
ATH-753, branch `research/ath-753-pythia-bang`. All 9 rungs exercise
existing tactics in the library. There are no LLM rungs and no
placeholder rungs: the ladder is the full surface. LLM-augmented
closure lives in the `kairos-sdk` companion under
