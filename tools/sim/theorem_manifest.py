...
MANIFEST: tuple[TheoremEntry, ...] = (
    ...
    TheoremEntry(
        ...
        mathlib_status="novel",
        summary="Put-call parity in discounted form: callPayoff - putPayoff = (S - K) * exp(-rT).",
        references=["Stoll, H.R. Journal of Finance 24(5): 801-824 (1969)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="DEX AMM impermanent loss is non-positive: (2 sqrt(r)) / (1 + r) - 1 <= 0 for r > 0.",
        references=["Angeris, G. and Chitra, T. Proceedings of AFT '20"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="GBM log-linearity: log(gbmTerminal) = log(S0) + (mu - sigma^2/2)*T + sigma*w.",
        references=["Black, F. and Scholes, M. J. Pol. Econ. 81(3): 637-654 (1973)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="Minimum-variance hedge optimum: hedgedVariance at h*=cSF/vF equals vS - cSF^2/vF.",
        references=["Ederington, L.H. Journal of Finance 34(1): 157-170 (1979)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="Sharpe-ratio structural identity: Sharpe(mu_hat) - Sharpe(mu*) = (mu_hat - mu*)/sigma.",
        references=["Sharpe, W.F. Journal of Business 39(S1): 119-138 (1966)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="sqrt(t) volatility scaling kernel: (sigma_d * sqrt(n))^2 = sigma_d^2 * n.",
        references=["Hull, J.C. Options Futures and Other Derivatives, 10th ed. §22.2 (2017)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="Continuous annuity strictly below perpetuity limit: (1 - exp(-rT))/r < 1/r for r,T > 0.",
        references=["Hull, J.C. Options Futures and Other Derivatives, 10th ed. §4.2 (2017)"],
    ),
    TheoremEntry(
        domain="finance",
        ...
        mathlib_status="novel",
        summary="Discount factor is bounded above by 1: exp(-(r*T)) <= 1 for r*T >= 0.",
        references=["Hull, J.C. Options Futures and Other Derivatives, 10th ed. §4.2 (2017)"],
    ),
    TheoremEntry(
        domain="finance",
